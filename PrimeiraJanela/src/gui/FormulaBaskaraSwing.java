 ...
 */
public class FormulaBaskaraSwing extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btCalcular) {
            ...
            //JOptionPane.showMessageDialog(this, "Programa Desenvolvido por Edson Ricardo Czarneski");
          new JanelaJava(this);//Instanciando o método construtor com janela anônima
